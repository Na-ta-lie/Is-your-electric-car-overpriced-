...
3.  I split the dataframe into two. A dataframe containing cars with prices called ecars (307 objects), and one containing cars missing prices called ecars_missing_price (51 objects).
...
305 electric cars with 45 unique car makes were included in the ecars data used to create the linear model. Additionally 14 makes that have 10 or more car models are highlighted throughout the project.
...
column(4,
plotlyOutput('p1', width = '420px', height = '500px')
)
...
column(4,
plotlyOutput('p2', width = '420px', height = '500px')
)
...
column(4, 
       plotOutput('histogram', width = '420px', height = '500px')
)
