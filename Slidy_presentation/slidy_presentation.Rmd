...
- Mercedes, BMWs, and, in particular, Porsches are priced higher than predicted.

- Fiats are a very good value based on their price and features. 

- Teslas are priced slightly below their predicted value. 

- Lotus Eletre is priced about 85,000 less than predicted. 

- Both the Lucid Air Dream Editions are priced almost 60,000 more than predicted

Future Work:

It would be interesting to include other features in the linear model. For example, the Make of the car likely makes a significant difference in the price. People are likely to pay more money for the name BMW than Fiat. 
